      ...
      <div style={{ marginLeft: 30 }}>
        ...
        <InputBlock label='구매가'>
          <div className='inline-field'>
            <input
              type="text"          // 입력 부드럽게 하려면 number 대신 text + inputMode
              inputMode="numeric"
              placeholder="0"
            ...
            <CategoryButton
              items={unit.items}
              size="small"
              selected={draft.unitName}
              onSelect={v => update('unitName', v)}
            />
          </div>
        </InputBlock>
            ...
            <InputBlock label='대출금'>
              <div className='inline-field'>
                <input
                  ...
                  inputMode="numeric"
                  placeholder="0"
                  value={draft.loanPrice}
                  onChange={e => update('loanPrice', e.target.value)}
                />
                <CategoryButton
                  items={unit.items}
                  size="small"
